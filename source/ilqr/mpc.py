...
class MPC(Module):
    ...
    def __init__(
        ...
        self.state_con_A = state_con_A
        self.state_con_b = state_con_b
        self.soft_const_opt = soft_const_opt
        self.soft_const_multiplier = soft_const_multiplier
    ...
    def solve_lqr_subproblem(self, x_init, C, c, F, f, cost, dynamics, x, u,
        ...
        if self.slew_rate_penalty is None or isinstance(cost, Module):
            _lqr = LQRStep(
                ...
                state_con_A=self.state_con_A,
                state_con_b=self.state_con_b,
                soft_const_opt=self.soft_const_opt,
                soft_const_multiplier=self.soft_const_multiplier
            )
